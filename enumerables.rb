...
# puts  "#{spicy_food[:name]}(#{spicy_food[:cuisine]}) | HeatLevel:#{spicy_food[:heat_level] > 5}"
if spicy_food[:heat_level] > 5
        # heat_level_emoji = "🌶" * spicy_food[:heat_level]

 "#{spicy_food[:name]}(#{spicy_food[:cuisine]}) | HeatLevel:#{spicy_food[:heat_level]}"
...
def average_heat_level spicy_foods
 total_heat_level = spicy_foods.sum do |spicy_food|
    spicy_food[:heat_level]
  end
...
# def average_heat_level(spicy_foods)
#   # your code here
#   heat_level_total = spicy_foods.sum do |spicy_food|
#     spicy_food[:heat_level]
